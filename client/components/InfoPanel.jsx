    ...
    <div className="info-panel">
      ...
      <div className="info-panel-content">
        ...
        <section className="info-panel-instruction-manual">
          <h3 className="instruction-manual">HOW TO USE</h3>
          ...
          <ul className="example-list">
            <ol onClick={() => setInput("What is the black plague?")}>
              What is the black plague?
            </ol>
            <ol onClick={() => setInput("Explain diabetes mellitus.")}>
              Explain diabetes mellitus.
            </ol>
            <ol onClick={() => setInput("What causes migraines?")}>
              What causes migraines?
            </ol>
            <ol onClick={() => setInput("Define arrhythmia.")}>
              Define arrhythmia.
            </ol>
          </ul>
        </section>
        <section>
          ...
          <p className="info-panel-limitations-quotas">
            ...
            a substitute for professional medical advice. <br />
