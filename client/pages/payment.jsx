...
export default function PaymentPage() {
  ...
  const onSubmit = (data) => {
    ...
    const isLoggedIn =
      localStorage.getItem("jwtToken") || localStorage.getItem("googleIdToken");
    if (!isLoggedIn) {
  ...
  return (
    <div className="payment-page" style={{ display: "flex" }}>
      <div className="payment-container-subscription" style={{ flex: "1" }}>
        <SubscriptionPage />
      </div>
      <div
