      ...
      <div className="hidden md:flex md:w-64 bg-white border-r border-gray-200 flex-col">
        ...
        <div className="p-4">
          ...
          <p className="text-sm text-gray-600 mb-4">
            MediTerms is an AI-powered chatbot designed to help you understand medical terminology and concepts.
          </p>
          <h2 className="text-sm font-semibold text-gray-600 uppercase tracking-wider mb-3 mt-6">Example Questions</h2>
          <ul className="space-y-2">
            <li className="text-sm text-green-600 hover:text-green-800 cursor-pointer">What is hypertension?</li>
            <li className="text-sm text-green-600 hover:text-green-800 cursor-pointer">Explain diabetes mellitus</li>
            <li className="text-sm text-green-600 hover:text-green-800 cursor-pointer">What causes migraines?</li>
            <li className="text-sm text-green-600 hover:text-green-800 cursor-pointer">Define arrhythmia</li>
          </ul>
        </div>
        <div className="mt-auto p-4 border-t border-gray-200">
          <p className="text-xs text-gray-500">
            © 2025 MediTerms. This is for informational purposes only and not a substitute for professional medical
            advice.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border-b border-gray-200 py-4 px-6 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-bold text-green-600 md:hidden flex items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="none"
